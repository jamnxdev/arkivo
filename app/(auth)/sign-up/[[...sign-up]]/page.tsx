    ...
    <main className="min-h-svh bg-background">
      <div className="grid min-h-svh w-full lg:grid-cols-2">
        <section className="relative hidden overflow-hidden border-r bg-linear-to-br from-muted/70 via-background to-muted/30 p-10 lg:block">
              ...
              <div className="space-y-7 text-left">
                <div className="space-y-3">
                  ...
                  <p className="text-base leading-7 text-muted-foreground">
                    ...
                    instantly, and understand spending without spreadsheet
                    chaos.
                  </p>
                </div>
          ...
          <div className="pointer-events-none absolute -top-16 -left-16 size-56 rounded-full border border-primary/20" />
